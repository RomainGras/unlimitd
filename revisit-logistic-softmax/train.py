...
def train(base_loader, val_loader, model, optimization, start_epoch, stop_epoch, params):
    ...
    if optimization == 'Adam':
        if params.method in ['CDKT', 'differentialDKT', 'differentialCDKT', 'differentialCDKTIX']:
            if params.method!='differentialDKT' : 
            ...
            if (params.method!='differentialDKT') and flag:
    ...
    for epoch in range(start_epoch, stop_epoch):
        ...
        if epoch%5==0:
            acc = model.test_loop(val_loader)
            outfile = os.path.join(params.checkpoint_dir, f'{epoch}_model.tar')
...
if __name__ == '__main__':
    ...
    elif params.method in ['differentialDKT', 'differentialCDKT', 'differentialCDKTIX', 'CDKT', 'DKT', 'protonet', 'matchingnet', 'relationnet', 'relationnet_softmax', 'maml', 'maml_approx', 'imaml']:
        n_query = max(1, int(
    ...
    if params.method in ['maml', 'maml_approx', 'imaml', 'imaml_approx']:
