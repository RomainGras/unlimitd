...
python test.py --dataset="miniImagenet" --method="differentialDKTIXnogpy" --train_n_way=5 --test_n_way=5 --n_shot=1 --seed=1 --train_aug --model="Conv4_diffDKTIX" --diff_net=no_norm --n_ft=10 --lr=.01 --temp=.04 --optim_based_test=True
