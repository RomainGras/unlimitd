...
#===================
# simple net regression (after a conv3)
#===================
...
#===================
# simple net classification (after a conv4)
#===================

# These ones are for CUB, with the architecture of the original paper (so their is one of them for each class)
class simple_netC_2hl(nn.Module):
    def __init__(self):
        super(simple_netC_2hl, self).__init__()
        self.layer1 = nn.Linear(1600, 40)
        self.layer2 = nn.Linear(40,40)
        self.layer3 = nn.Linear(40,5)
...
class simple_netC_2hl_1o(nn.Module):
    def __init__(self):
        super(simple_netC_2hl_1o, self).__init__()
        self.layer1 = nn.Linear(1600, 40)
        self.layer2 = nn.Linear(40,40)
        self.layer3 = nn.Linear(40,1)
...
class simple_netC_1hl(nn.Module):
    def __init__(self):
        super(simple_netC_1hl, self).__init__()
        self.layer1 = nn.Linear(1600, 40)
        self.layer2 = nn.Linear(40,5)
...
class simple_netC_1hl_1o(nn.Module):
    def __init__(self):
        super(simple_netC_1hl_1o, self).__init__()
        self.layer1 = nn.Linear(1600, 40)
...
class simple_netC_0hl_1o(nn.Module):
    def __init__(self):
        super(simple_netC_0hl_1o, self).__init__()
        self.layer1 = nn.Linear(1600, 1)
...
class Identity(nn.Module):
    def __init__(self):
        ...
        self.final_feat_dim = [3,84,84]
    
    def forward(self, x):
        return x

# The following would be for CUB in the way we computed in the paper :
class simple_net_multi_outputCUB(nn.Module):
    def __init__(self):
        super(simple_net_multi_outputC, self).__init__()
        self.layer1 = nn.Linear(40,40)
        self.layer2 = nn.Linear(40,200)
