...
class MetaTemplate(nn.Module):
    def __init__(self, model_func, n_way, n_support, change_way = True):
        ...
        self.feature    = model_func   # erase Parenthesis behind model_func if MAML regression
        # self.feat_dim   = self.feature.final_feat_dim   # COMMENT THIS LINE if MAML regression
